...
public class TestNumberSystem {
    public static void main(String[] args) {
        ...
        for(int i = 0; i < 3; i++){
            ...
            MyNumber aNumber = new MyNumber(originalNumber,radix);
            aNumber.setNumber(originalNumber,radix);
            BinaryConverter binary = new BinaryConverter(aNumber);
            OctalConverter octal = new OctalConverter(aNumber);
            HexadecimalConverter hex = new HexadecimalConverter(aNumber);
            aNumber.addConverter(binary);
            aNumber.addConverter(octal);
            aNumber.addConverter(hex);
